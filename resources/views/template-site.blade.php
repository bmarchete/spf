            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{route('siteAtividades')}}">
                                        <div class="navegacao-adm">Cronograma</div>
                                    </a>
                                </li>

                                <li><a href="{{route('site.pontuacoes.equipes')}}">
                                        <div class="navegacao-adm">Placar</div>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{route('siteEquipes')}}">
